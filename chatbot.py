...
@app.route("/chat/")
def chat():
    return chat_form_html.replace('<p id="credit"></p>', '<p id="credit">This is a demo of the eliza submodule of the <a href="http://www.nltk.org/api/nltk.chat.html">NLTK chat module</a>.</p>')
